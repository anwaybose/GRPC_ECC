...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.JoinHello = channel.unary_unary(
                '/greet.Greeter/JoinHello',
                request_serializer=greet__pb2.Hello_join_Request.SerializeToString,
                response_deserializer=greet__pb2.HelloReply.FromString,
                )
        self.CertHello = channel.unary_unary(
                '/greet.Greeter/CertHello',
                request_serializer=greet__pb2.Hello_cert_Request.SerializeToString,
                response_deserializer=greet__pb2.HelloReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'JoinHello': grpc.unary_unary_rpc_method_handler(
                    servicer.JoinHello,
                    request_deserializer=greet__pb2.Hello_join_Request.FromString,
                    response_serializer=greet__pb2.HelloReply.SerializeToString,
            ),
            'CertHello': grpc.unary_unary_rpc_method_handler(
                    servicer.CertHello,
                    request_deserializer=greet__pb2.Hello_cert_Request.FromString,
                    response_serializer=greet__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def JoinHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/greet.Greeter/JoinHello',
            greet__pb2.Hello_join_Request.SerializeToString,
            greet__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def CertHello(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/greet.Greeter/CertHello',
            greet__pb2.Hello_cert_Request.SerializeToString,
            greet__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
